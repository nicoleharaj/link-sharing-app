...
export default function MainContent() {
  ...
  return (
    <main className="flex h-[calc(100vh-102px)] items-start justify-center gap-3 p-3 tablet:p-3">
      <Mockup links={links} />
      <Container className="flex flex-col gap-6 p-0 tablet:py-3 desktop:min-h-full desktop:w-4/5">
